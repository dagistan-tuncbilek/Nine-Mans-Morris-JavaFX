...
public class Stone extends Piece{
	...
	public Stone(List<PieceColor> pieceColorList, int piecePosition, PieceColor color) {
	...
	public List<Move> calculateLegalMoves(List<PieceColor> pieceColorList) {
		...
		for (final int currentCandidateTile : MoveUtils.getStoneCandidateCoordinates(getPiecePosition())) {
